...
// WithRunProgram sets the RunProgram field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the RunProgram field is set to the value of the last call.
func (b *UpdateSpecApplyConfiguration) WithRunProgram(value bool) *UpdateSpecApplyConfiguration {
	b.RunProgram = &value
	return b
}
