...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitDependencyStatus) DeepCopyInto(out *GitDependencyStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitDependencyStatus.
func (in *GitDependencyStatus) DeepCopy() *GitDependencyStatus {
	if in == nil {
		return nil
	}
	out := new(GitDependencyStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StackSpec) DeepCopyInto(out *StackSpec) {
	*out = *in
	...
	if in.ConfigRef != nil {
		...
		*out = make(map[string]ConfigMapRef, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	...
	if in.GitDependencies != nil {
		in, out := &in.GitDependencies, &out.GitDependencies
		*out = make([]GitDependency, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.UpdateTemplate != nil {
		in, out := &in.UpdateTemplate, &out.UpdateTemplate
		*out = (*in).DeepCopy()
	}
}
...
func (in *StackStatus) DeepCopyInto(out *StackStatus) {
	*out = *in
	...
	if in.GitDependencies != nil {
		in, out := &in.GitDependencies, &out.GitDependencies
		*out = make(map[string]GitDependencyStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
