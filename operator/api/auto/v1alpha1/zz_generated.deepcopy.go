...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StubSource) DeepCopyInto(out *StubSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StubSource.
func (in *StubSource) DeepCopy() *StubSource {
	if in == nil {
		return nil
	}
	out := new(StubSource)
