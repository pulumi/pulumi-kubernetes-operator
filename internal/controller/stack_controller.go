...
import (
	...
	pulumiv1 "github.com/pulumi/pulumi-kubernetes-operator/api/v1"
	"github.com/pulumi/pulumi-kubernetes-operator/internal/logging"
...
func add(mgr manager.Manager, r *StackReconciler) error {
	var err error
...
func (r *StackReconciler) Reconcile(ctx context.Context, request ctrl.Request) (res ctrl.Result, reterr error) {
	...
	stack := instance.Spec
	sess := newStackReconcilerSession(reqLogger, stack, r.Client, request.Namespace)
...
func (r *StackReconciler) markStackFailed(sess *StackReconcilerSession, instance *pulumiv1.Stack, err error, currentCommit string, permalink shared.Permalink) {
...
func (sess *StackReconcilerSession) finalize(ctx context.Context, stack *pulumiv1.Stack) error {
...
// time.
func (sess *StackReconcilerSession) removeFinalizerAndUpdate(ctx context.Context, instance *pulumiv1.Stack) error {
...
func (sess *StackReconcilerSession) finalizeStack(ctx context.Context) error {
...
// spec.
func (sess *StackReconcilerSession) addFinalizerAndUpdate(ctx context.Context, stack *pulumiv1.Stack) error {
...
func (sess *StackReconcilerSession) SetEnvs(ctx context.Context, configMapNames []string, namespace string) error {
...
func (sess *StackReconcilerSession) SetSecretEnvs(ctx context.Context, secrets []string, namespace string) error {
...
func (sess *StackReconcilerSession) SetEnvRefsForWorkspace(ctx context.Context, w auto.Workspace) error {
...
func (sess *StackReconcilerSession) runCmd(title string, cmd *exec.Cmd, workspace auto.Workspace) (string, string, error) {
...
func (sess *StackReconcilerSession) lookupPulumiAccessToken(ctx context.Context) (string, bool) {
...
func (sess *StackReconcilerSession) MakeRootDir(ns, name string) (string, error) {
...
func (sess *StackReconcilerSession) cleanupRootDir() {
	if sess.rootDir == "" {
		return
	}
...
func (sess *StackReconcilerSession) getPulumiHome() string {
...
func (sess *StackReconcilerSession) MakeWorkspaceDir() (string, error) {
...
func (sess *StackReconcilerSession) CleanupWorkspaceDir() {
	if sess.rootDir == "" {
		return
	}
...
func (sess *StackReconcilerSession) getWorkspaceDir() string {
	return filepath.Join(sess.rootDir, "workspace")
}

func (sess *StackReconcilerSession) SetupWorkdirFromGitSource(ctx context.Context, gitAuth *auto.GitAuth, source *shared.GitSource) (string, error) {
	repo := auto.GitRepo{
...
func (sess *StackReconcilerSession) SetupWorkdirFromYAML(ctx context.Context, programRef shared.ProgramReference) (string, error) {
	homeDir := sess.getPulumiHome()
	workspaceDir := sess.getWorkspaceDir()
	sess.logger.Debug("Setting up pulumi workspace for stack", "stack", sess.stack, "workspace", workspaceDir)
...
func (sess *StackReconcilerSession) setupWorkspace(ctx context.Context, w auto.Workspace) error {
...
func (sess *StackReconcilerSession) ensureStackSettings(ctx context.Context, w auto.Workspace) error {
...
func (sess *StackReconcilerSession) InstallProjectDependencies(ctx context.Context, workspace auto.Workspace) error {
...
func (sess *StackReconcilerSession) RefreshStack(ctx context.Context, expectNoChanges bool, targets []string) (shared.Permalink, error) {
...
func (sess *StackReconcilerSession) UpdateStack(ctx context.Context, targets []string) (shared.StackUpdateStatus, shared.Permalink, *auto.UpResult, error) {
...
func (sess *StackReconcilerSession) DestroyStack(ctx context.Context) error {
...
// Add default permalink for the stack in the Pulumi Service.
func (sess *StackReconcilerSession) addDefaultPermalink(ctx context.Context, stack *pulumiv1.Stack) error {
	// Get stack URL.
...
func (sess *StackReconcilerSession) patchStatus(ctx context.Context, o *pulumiv1.Stack) error {
...
// git cloning.
func (sess *StackReconcilerSession) addSSHKeysToKnownHosts(projectRepoURL string) error {
...
func (r *StackReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&pulumicomv1alpha1.Stack{}).
		For(&pulumicomv1.Stack{}).
		Complete(r)
}
