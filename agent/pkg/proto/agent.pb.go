...
type SetAllConfigRequest struct {
	...
	Config []*ConfigItem `protobuf:"bytes,1,rep,name=config,proto3" json:"config,omitempty"`
}
...
func (m *ConfigItem) GetV() isConfigItem_V {
	if m != nil {
		return m.V
	}
	return nil
...
func (x *ConfigItem) GetValue() *structpb.Value {
	if x, ok := x.GetV().(*ConfigItem_Value); ok {
		return x.Value
	}
	return nil
}
...
func (x *ConfigItem) GetValueFrom() *ConfigValueFrom {
	if x, ok := x.GetV().(*ConfigItem_ValueFrom); ok {
		return x.ValueFrom
	}
	return nil
}
...
var file_agent_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x10, 0x0a, 0x0e, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x0f, 0x0a, 0x0d, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c,
	0x6c, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x08, 0x70, 0x61,
	...
	0x6f, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x88, 0x01, 0x01, 0x12, 0x16, 0x0a, 0x06, 0x74,
	0x61, 0x72, 0x67, 0x65, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x74, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6c, 0x6c, 0x65, 0x6c,
	...
	0x65, 0x73, 0x22, 0x7c, 0x0a, 0x0d, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x53, 0x74, 0x72,
	...
	0x6c, 0x69, 0x6e, 0x6b, 0x32, 0xa5, 0x04, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74,
...
var file_agent_proto_goTypes = []any{
	...
	nil,                           // 28: agent.UpResult.OutputsEntry
...
var file_agent_proto_depIdxs = []int32{
	...
	29, // 2: agent.StackSummary.last_update:type_name -> google.protobuf.Timestamp
	8,  // 3: agent.SetAllConfigRequest.config:type_name -> agent.ConfigItem
	30, // 4: agent.ConfigItem.value:type_name -> google.protobuf.Value
	9,  // 5: agent.ConfigItem.value_from:type_name -> agent.ConfigValueFrom
	31, // 6: agent.RefreshStream.event:type_name -> google.protobuf.Struct
	...
	31, // 10: agent.PreviewStream.event:type_name -> google.protobuf.Struct
	...
	31, // 14: agent.UpStream.event:type_name -> google.protobuf.Struct
	22, // 15: agent.UpStream.result:type_name -> agent.UpResult
	24, // 16: agent.UpResult.summary:type_name -> agent.UpdateSummary
	28, // 17: agent.UpResult.outputs:type_name -> agent.UpResult.OutputsEntry
	29, // 18: agent.UpdateSummary.start_time:type_name -> google.protobuf.Timestamp
	29, // 19: agent.UpdateSummary.end_time:type_name -> google.protobuf.Timestamp
	31, // 20: agent.DestroyStream.event:type_name -> google.protobuf.Struct
